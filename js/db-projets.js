const dbProjets = [
  ...
  },
  {
    ...
    client: "Personnel",
    description:
      "LumiWood est une lampe connectée en bois équipée de 100 LED, d'un petit écran et de capteurs tactiles. " +
      "Créez vos propres animations lumineuses grâce à la matrice de LED, " +
  ...
  },
  {
    ...
    client: "Trophées NSI",
    description:
      "L'origine de ce projet découle du constat que de nombreuses personnes ne savent pas comment trier leurs déchets correctement, " +
  ...
  },
  {
    ...
    client: "Trijam",
    description:
      "Dans JumpingHell, saute de plateforme en plateforme. " +
      "Si tu tombes, tu atterris en enfer. " +
  ...
  {
    id: 5,
    titre: "Let Me Diiiiie",
    start_date: "2021-08-27",
    end_date: "2021-08-30",
    client: "Trijam",
    description:
      "Un seul but, mourir. " +
      "Dans LetMeDiiiiie, entre la vie et la mort, " +
      "le seul moyen de gagner est d'être tué par Cerber, " +
  ...
  },
  {
    ...
    url: [
      ...
      {
        name: "Voir le site",
        link: "https://green-growth.www.untypequicode.fr/",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    client: "Personnel",
    description:
      "Ici, je partage mes astuces et découvertes pour une vie numérique plus sécurisée. " +
    ...
    url: [
      ...
      {
        name: "Voir le site",
        link: "https://libreshield.www.untypequicode.fr/",
      },
    ],
  },
  {
    ...
    client: "Personnel",
    description:
      "Script.js est un framework JavaScript minimaliste pour créer des sites web modernes et dynamiques. " +
    ...
    url: [
      ...
      {
        name: "Voir le site",
        link: "https://script.js.www.untypequicode.fr/",
      },
    ],
  },
  {
    ...
    client: "Personnel",
    description:
      "Style.css est une bibliothèque CSS minimaliste pour styliser vos sites web. " +
      "Il est conçu pour être simple, léger et facile à utiliser.",
    ...
    url: [
      ...
      {
        name: "Voir le site",
        link: "https://style.css.www.untypequicode.fr/",
      },
    ],
  },
];
